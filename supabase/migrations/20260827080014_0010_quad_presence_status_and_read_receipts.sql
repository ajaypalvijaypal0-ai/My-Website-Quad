...
## 1. profiles: presence_status (online/offline/away/busy/invisible)
## 2. profiles: read_receipts_enabled (boolean, default true)
## 3. profiles: last_seen_visible (boolean, default true)
## 4. mark_messages_seen RPC — privacy-aware (only upgrades to seen if receipts enabled)
